...
3. Run NoddiSurfaceMapping.sh - input should be \<StudyFolder\> and \<Subject directory(s)\>, which were used to preprocess with HCP pipeline/DiffusionPreprocessing
